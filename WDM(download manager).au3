...
While 1
	...
	Switch $nMsg
		...
		Case $btnStart
			...
			$numOfDownloadSignature = GUICtrlRead($numOfDownloadsLabel) + 1
			If $numOfDownloadSignature = GUICtrlRead($numOfDownloadsLabel) + 1 Then
...
$_btnResume = GUICtrlCreateButton("Resume", 56, 261, 57, 25)
GUICtrlSetFont(-1, 8, 800, 4, "MS Sans Serif")
GUICtrlSetColor(-1, 0x008000)
GUICtrlSetTip(-1, "click to Resume download")
$_btnPause = GUICtrlCreateButton("Pause", 112, 261, 49, 25)
GUICtrlSetFont(-1, 8, 800, 4, "MS Sans Serif")
GUICtrlSetColor(-1, 0x008000)
GUICtrlSetTip(-1, "click to pause download")
$btnCancel = GUICtrlCreateButton("Cancel", 160, 261, 57, 25)
GUICtrlSetFont(-1, 8, 800, 4, "MS Sans Serif")
GUICtrlSetColor(-1, 0x008000)
...
#EndRegion ### END Koda GUI section ###
			...
			$hdownload = InetGet(GUICtrlRead($InputUrl),GUICtrlRead($InputFolder)&"\"&GUICtrlRead($InputFileName),$INET_FORCERELOAD,$INET_DOWNLOADBACKGROUND)
			...
			$FileSizeDownloaded = InetGetInfo($hdownload,$INET_DOWNLOADREAD)
			$FileDownloadStatus = InetGetinfo($hdownload,$INET_DOWNLOADCOMPLETE)
			$isDownloadSuccess =  InetGetInfo($hdownload,$INET_DOWNLOADSUCCESS)
			$percentDownloaded = (InetGetInfo($hdownload,$INET_DOWNLOADREAD)/InetGetInfo($hdownload,$INET_DOWNLOADSIZE))*100
			$isDownloadSize = InetGetInfo($hdownload,$INET_DOWNLOADSIZE)
